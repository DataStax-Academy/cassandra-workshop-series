...
|---|---|
| 0. Create your Astra instance   | [here](#1-create-your-astra-instance-reminders) |
...
| 5. Homeworks | [here](https://community.datastax.com/questions/6377/materials-and-homework-for-week-3.html) |
...
**✅ Step 2a.Step 1d.Open DataStax Studio**
...
**✅ Step 2b. Import the notebook** : DataStax studio should now be opened.
...
- Download locally the file `spacecraft` located in folder `notebooks` [here](https://github.com/DataStax-Academy/cassandra-workshop-series/raw/master/week3-AppDev-crud/notebooks/spacecraft.tar)
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/DataStax-Academy/cassandra-workshop-series/tree/master/week3-AppDev-crud)
...
The file path is located at `/workspace/cassandra-workshop-series/secure-connect-dev-workshop-db.zip` (because my db name is  `dev-workshop-db`).

Exercises will be different for each language. Pick then language you feel the most confortuable with with and JUMP to dedicated README.
...
| **![CSHARP](https://raw.githubusercontent.com/DataStax-Academy/cassandra-workshop-series/master/materials/images/logo-csharp.png)** | [Exercises 3 to 5 with CSHARP](./README_CSHARP.MD) |
