...
String SECURE_CONNECT_BUNDLE = "<>/secure-connect-killrvideoclusters.zip";
...
```
mvn test -Dtest=com.datastax.workshop.Ex03_CreateUpdateDelete#insert_a_journey#save_readings
```
