...
Navigate to [http://localhost:5000](http://localhost:5000) and to [http://localhost:3000](http://localhost:3000), complete the connection dialog with your details, and connect to your Astra database. 
